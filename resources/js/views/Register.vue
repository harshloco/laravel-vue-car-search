<template>
  <div id="loginForm" class="pt-5">
    <b-form v-on:submit.prevent="signUp" class="mx-auto justify-content-center w-50">
      <b-form-group id="registerErrors" class="errorsBlock" v-show="containsErrors()">
        <ul>
          <li
            v-for="error in this.$store.getters.getRegisterErrors"
            :key="error"
          >{{ error.message }}</li>
        </ul>
      </b-form-group>
      <b-form-group horizontal label="Login: " label-for="login">
        <b-form-input
          id="login"
          name="login"
          type="text"
      ...
      <b-form-group horizontal label="Email: " label-for="login">
        <b-form-input
          id="email"
          name="email"
          type="text"
      ...
      <b-form-group horizontal label="Confirm your password:" label-for="password">
        <b-form-input
          id="confirmPassword"
